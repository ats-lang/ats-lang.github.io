...
//
  ...
  tmp149 = ats2jspre_ref_get_elt(env0);
  tmp150 = ATSPMVlazyval_eval(tmp149); 
  if(ATSCKptrisnull(tmp150)) {
    ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats/contrib/libatscc/ATS2-0.3.2/DATS/stream.dats: 7300(line=479, offs=5) -- 7324(line=479, offs=29)");
  } // ifthen
  tmp151 = tmp150[0];
  tmp152 = tmp150[1];
  ats2jspre_ref_set_elt(env0, tmp152);
