...
if (((ats_sum_ptr_type)tmp30)->tag != 49) { ats_caseof_failure_handle ("/home/hwxi/Research/ATS-Postiats/src/pats_ccomp_lazyeval.dats: 2915(line=102, offs=5) -- 2956(line=102, offs=46)") ; }
...
if (((ats_sum_ptr_type)tmp70)->tag != 50) { ats_caseof_failure_handle ("/home/hwxi/Research/ATS-Postiats/src/pats_ccomp_lazyeval.dats: 4591(line=157, offs=5) -- 4637(line=157, offs=51)") ; }
