...
** The starting compilation time is: 2016-10-12: 10h:42m
**
*/
...
//
  ...
  tmpret85 = _ats2jspre_ML_list0_aux_51(arg2, arg1, arg0);
  return tmpret85;
} // end-of-function


function
_ats2jspre_ML_list0_aux_51(env0, arg0, arg1)
{
//
// knd = 1
  var apy0
  ...
  while(true) {
    ...
    while(true) {
      ...
      switch(tmplab) {
        ...
        tmp87 = arg1[0];
        tmp88 = arg1[1];
        tmp89 = env0[0](env0, arg0, tmp87);
        // ATStailcalseq_beg
        apy0 = tmp89;
        apy1 = tmp88;
        arg0 = apy0;
        arg1 = apy1;
        funlab_js = 1; // __patsflab__ats2jspre_ML_list0_aux_51
        // ATStailcalseq_end
        break;
        // ATSbranchseq_end
      } // end-of-switch
...
//
  ...
  tmpret90 = _ats2jspre_ML_list0_aux_53(arg1, arg2, arg0, arg2);
  return tmpret90;
} // end-of-function


function
_ats2jspre_ML_list0_aux_53(env0, env1, arg0, arg1)
{
//
// knd = 0
  var tmpret91
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      tmp92 = arg0[0];
      tmp93 = arg0[1];
      tmp94 = _ats2jspre_ML_list0_aux_53(env0, env1, tmp93, env1);
      tmpret91 = env0[0](env0, tmp92, tmp94);
      break;
      // ATSbranchseq_end
    } // end-of-switch
    if (tmplab_js === 0) break;
...
//
  ...
  tmp98 = ats2jspre_list_sort_2(arg0, arg1);
  tmpret97 = tmp98;
  return tmpret97;
} // end-of-function
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      tmpret99 = ats2jspre_ListSubscriptExn_throw();
      break;
      // ATSbranchseq_end
    } // end-of-switch
    if (tmplab_js === 0) break;
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      tmpret102 = ats2jspre_ListSubscriptExn_throw();
      break;
      // ATSbranchseq_end
    } // end-of-switch
    if (tmplab_js === 0) break;
  ...
  while(true) {
    ...
    while(true) {
      ...
      switch(tmplab) {
        ...
        tmpret105 = ats2jspre_ListSubscriptExn_throw();
        break;
        // ATSbranchseq_end
        // ATSbranchseq_beg
        ...
        tmp106 = arg0[0];
        tmp107 = arg0[1];
        tmp108 = ats2jspre_gt_int1_int1(arg1, 0);
        if(tmp108) {
          tmp109 = ats2jspre_sub_int1_int1(arg1, 1);
          // ATStailcalseq_beg
          apy0 = tmp107;
          apy1 = tmp109;
          arg0 = apy0;
...
//
  ...
  tmpret110 = _ats2jspre_ML_list0_aux_60(arg2, arg0, arg1);
  return tmpret110;
} // end-of-function
...
//
  ...
  tmp112 = ats2jspre_gt_int1_int1(arg1, 0);
  if(tmp112) {
    // ATScaseofseq_beg
    tmplab_js = 1;
    while(true) {
      ...
      switch(tmplab) {
        ...
        tmpret111 = ats2jspre_ListSubscriptExn_throw();
        break;
        // ATSbranchseq_end
        // ATSbranchseq_beg
        ...
        tmp113 = arg0[0];
        tmp114 = arg0[1];
        tmp116 = ats2jspre_sub_int1_int1(arg1, 1);
        tmp115 = _ats2jspre_ML_list0_aux_60(env0, tmp114, tmp116);
        tmpret111 = [tmp113, tmp115];
        break;
        // ATSbranchseq_end
      } // end-of-switch
      if (tmplab_js === 0) break;
...
//
  ...
  tmpret117 = _ats2jspre_ML_list0_aux_62(arg0, arg1);
  return tmpret117;
} // end-of-function
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      tmpret118 = ats2jspre_ListSubscriptExn_throw();
      break;
      // ATSbranchseq_end
      // ATSbranchseq_beg
      ...
      if(tmp121) {
        ...
        tmp122 = _ats2jspre_ML_list0_aux_62(tmp120, tmp123);
        tmpret118 = [tmp119, tmp122];
      } else {
        tmpret118 = tmp120;
      } // endif
      break;
