...
//
  ...
  if(!ATSCKpat_con1(arg0, 0)) ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats-contrib/contrib/libatscc/libatscc2js/DATS/Bacon.js/baconjs_ext.dats: 3361(line=185, offs=11) -- 3380(line=185, offs=30)");
  tmp26 = arg0[1];
...
//
  ...
  if(!ATSCKpat_con1(arg0, 0)) ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats-contrib/contrib/libatscc/libatscc2js/DATS/Bacon.js/baconjs_ext.dats: 3561(line=196, offs=11) -- 3578(line=196, offs=28)");
  tmp31 = arg0[1];
  tmp32 = [1, tmp31];
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      if(!ATSCKpat_con1(arg0, 0)) ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats-contrib/contrib/libatscc/libatscc2js/DATS/Bacon.js/baconjs_ext.dats: 4509(line=250, offs=5) -- 4566(line=250, offs=62)");
      ...
      while(true) {
        ...
        switch(tmplab) {
          ...
          if(ATSCKptrisnull(tmp60)) ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats-contrib/contrib/libatscc/libatscc2js/DATS/Bacon.js/baconjs_ext.dats: 4540(line=250, offs=36) -- 4565(line=250, offs=61)");
