...
** The starting compilation time is: 2016-11-13: 16h:12m
**
*/
...
//
  ...
  if(!ATSCKpat_con1(arg0, 0)) ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats-contrib/contrib/libatscc/libatscc2js/DATS/Bacon.js/baconjs_ext.dats: 3357(line=182, offs=47) -- 3376(line=182, offs=66)");
  tmp26 = arg0[1];
...
//
  ...
  if(!ATSCKpat_con1(arg0, 0)) ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats-contrib/contrib/libatscc/libatscc2js/DATS/Bacon.js/baconjs_ext.dats: 3534(line=190, offs=32) -- 3551(line=190, offs=49)");
  tmp31 = arg0[1];
  tmp32 = [1, tmp31];
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      if(!ATSCKpat_con1(arg0, 0)) ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats-contrib/contrib/libatscc/libatscc2js/DATS/Bacon.js/baconjs_ext.dats: 4487(line=244, offs=5) -- 4544(line=244, offs=62)");
      ...
      while(true) {
        ...
        switch(tmplab) {
          ...
          if(ATSCKptrisnull(tmp60)) ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats-contrib/contrib/libatscc/libatscc2js/DATS/Bacon.js/baconjs_ext.dats: 4518(line=244, offs=36) -- 4543(line=244, offs=61)");
