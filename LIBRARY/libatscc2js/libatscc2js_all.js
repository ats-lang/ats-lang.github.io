...
** The starting compilation time is: 2016-8-9: 12h:20m
**
*/
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      if(ATSCKptrisnull(tmp95)) ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats-contrib/contrib/libatscc/DATS/stream.dats: 4682(line=303, offs=1) -- 4774(line=305, offs=50)");
...
//
  ...
  if(ATSCKptrisnull(tmp104)) ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats-contrib/contrib/libatscc/DATS/stream.dats: 5075(line=331, offs=5) -- 5099(line=331, offs=29)");
  tmp105 = tmp104[0];
  tmp106 = tmp104[1];
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      tmpret86 = ats2jspre_ListSubscriptExn_throw();
      break;
      // ATSbranchseq_end
    } // end-of-switch
    if (tmplab_js === 0) break;
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      tmpret89 = ats2jspre_ListSubscriptExn_throw();
      break;
      // ATSbranchseq_end
    } // end-of-switch
    if (tmplab_js === 0) break;
