...
** The starting compilation time is: 2015-10-9:  9h:10m
**
*/
...
function
ats2jspre_stream2cloref(arg0, arg1)
{
//
// knd = 0
  var tmpret21
  ...
  var tmplab, tmplab_js
//
  // __patsflab_stream2cloref
  tmp22 = ats2jspre_ref(arg0);
  tmp23 = ats2jspre_ref(arg1);
  tmpret21 = _ats2jspre_stream_patsfun_8__closurerize(tmp22, tmp23);
  return tmpret21;
} // end-of-function
...
//
  ...
  tmp25 = ats2jspre_ref_get_elt(env0);
  ATSPMVlazyval_eval(tmp25); tmp26 = tmp25[1];
  // ATScaseofseq_beg
  tmplab_js = 1;
  while(true) {
    tmplab = tmplab_js; tmplab_js = 0;
    switch(tmplab) {
      ...
      case 2: // __atstmplab9
      tmpret24 = ats2jspre_ref_get_elt(env1);
      break;
      // ATSbranchseq_end
      // ATSbranchseq_beg
      ...
      tmp27 = tmp26[0];
      tmp28 = tmp26[1];
      ats2jspre_ref_set_elt(env0, tmp28);
      ats2jspre_ref_set_elt(env1, tmp27);
      tmpret24 = tmp27;
      break;
      // ATSbranchseq_end
    } // end-of-switch
