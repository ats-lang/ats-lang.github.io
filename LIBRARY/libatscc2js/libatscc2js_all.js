...
** The starting compilation time is: 2016-7-25: 19h: 0m
**
*/
...
function
_ats2jspre_stream_patsfun_5__closurerize(env0, env1)
{
  return [function(cenv) { return _ats2jspre_stream_patsfun_5(cenv[1], cenv[2]); }, env0, env1];
}


function
_ats2jspre_stream_patsfun_8__closurerize(env0, env1)
{
  return [function(cenv) { return _ats2jspre_stream_patsfun_8(cenv[1], cenv[2]); }, env0, env1];
}
...
function
_ats2jspre_stream_patsfun_12__closurerize(env0)
{
  return [function(cenv) { return _ats2jspre_stream_patsfun_12(cenv[1]); }, env0];
}
...
//
  ...
  tmpret0 = _ats2jspre_stream_loop_1(arg0, arg1);
  return tmpret0;
} // end-of-function


function
_ats2jspre_stream_loop_1(arg0, arg1)
{
//
// knd = 1
  var apy0
...
//
  while(true) {
    funlab_js = 0;
    // __patsflab__ats2jspre_stream_loop_1
    ATSPMVlazyval_eval(arg0); tmp2 = arg0[1];
    // ATScaseofseq_beg
    tmplab_js = 1;
    while(true) {
      tmplab = tmplab_js; tmplab_js = 0;
      switch(tmplab) {
        ...
        tmp3 = tmp2[0];
        tmp4 = tmp2[1];
        tmp5 = ats2jspre_gt_int1_int1(arg1, 0);
        if(tmp5) {
          tmp6 = ats2jspre_pred_int1(arg1);
          // ATStailcalseq_beg
          apy0 = tmp4;
          apy1 = tmp6;
          arg0 = apy0;
          arg1 = apy1;
          funlab_js = 1; // __patsflab__ats2jspre_stream_loop_1
          // ATStailcalseq_end
        } else {
          tmpret1 = [tmp3];
        } // endif
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      tmp13 = ats2jspre_stream_map_cloref(tmp11, env1);
      tmpret8 = [tmp12, tmp13];
      break;
      // ATSbranchseq_end
    } // end-of-switch
...
//
  ...
  tmpret14 = ATSPMVlazyval(_ats2jspre_stream_patsfun_5__closurerize(arg0, arg1))
  return tmpret14;
} // end-of-function


function
_ats2jspre_stream_patsfun_5(env0, env1)
{
//
// knd = 0
  var tmpret15
...
//
  ...
  ATSPMVlazyval_eval(env0); tmp16 = env0[1];
  // ATScaseofseq_beg
  tmplab_js = 1;
  while(true) {
    tmplab = tmplab_js; tmplab_js = 0;
    switch(tmplab) {
      ...
      tmp17 = tmp16[0];
      tmp18 = tmp16[1];
      tmp19 = env1[0](env1, tmp17);
      if(tmp19) {
        tmp20 = ats2jspre_stream_filter_cloref(tmp18, env1);
        tmpret15 = [tmp17, tmp20];
      } else {
        tmp21 = ats2jspre_stream_filter_cloref(tmp18, env1);
        ATSPMVlazyval_eval(tmp21); tmpret15 = tmp21[1];
      } // endif
      break;
      // ATSbranchseq_end
    } // end-of-switch
...
//
  ...
  tmpret22 = _ats2jspre_stream_aux_7(arg0, 0);
  return tmpret22;
} // end-of-function


function
_ats2jspre_stream_aux_7(env0, arg0)
{
//
// knd = 0
  var tmpret23
  var tmplab, tmplab_js
//
  // __patsflab__ats2jspre_stream_aux_7
  tmpret23 = ATSPMVlazyval(_ats2jspre_stream_patsfun_8__closurerize(env0, arg0))
  return tmpret23;
} // end-of-function


function
_ats2jspre_stream_patsfun_8(env0, env1)
{
//
// knd = 0
  var tmpret24
...
//
  ...
  tmp25 = env0[0](env0, env1);
  tmp27 = ats2jspre_add_int1_int1(env1, 1);
  tmp26 = _ats2jspre_stream_aux_7(env0, tmp27);
  tmpret24 = [tmp25, tmp26];
  return tmpret24;
} // end-of-function
...
//
  ...
  tmp29 = ats2jspre_ref(arg0);
  tmpret28 = _ats2jspre_stream_patsfun_10__closurerize(tmp29);
  return tmpret28;
} // end-of-function
...
//
  ...
  tmp31 = ats2jspre_ref_get_elt(env0);
  ATSPMVlazyval_eval(tmp31); tmp32 = tmp31[1];
  if(ATSCKptrisnull(tmp32)) ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats-contrib/contrib/libatscc/DATS/stream.dats: 1570(line=116, offs=5) -- 1594(line=116, offs=29)");
  tmp33 = tmp32[0];
  tmp34 = tmp32[1];
  ats2jspre_ref_set_elt(env0, tmp34);
  tmpret30 = tmp33;
  return tmpret30;
} // end-of-function
...
//
  ...
  tmp37 = ats2jspre_ref(arg0);
  tmpret36 = _ats2jspre_stream_patsfun_12__closurerize(tmp37);
  return tmpret36;
} // end-of-function


function
_ats2jspre_stream_patsfun_12(env0)
{
//
// knd = 0
  var tmpret38
...
//
  ...
  tmp39 = ats2jspre_ref_get_elt(env0);
  ATSPMVlazyval_eval(tmp39); tmp40 = tmp39[1];
  // ATScaseofseq_beg
  tmplab_js = 1;
  while(true) {
    tmplab = tmplab_js; tmplab_js = 0;
    switch(tmplab) {
      ...
      if(ATSCKptriscons(tmp40)) { tmplab_js = 4; break; }
      ...
      tmp41 = tmp40[0];
      tmp42 = tmp40[1];
      ats2jspre_ref_set_elt(env0, tmp42);
      tmpret38 = [tmp41];
      break;
      // ATSbranchseq_end
    } // end-of-switch
...
//
  ...
  tmp45 = ats2jspre_ref(arg0);
  tmp46 = ats2jspre_ref(arg1);
  tmpret44 = _ats2jspre_stream_patsfun_14__closurerize(tmp45, tmp46);
  return tmpret44;
} // end-of-function
...
//
  ...
  tmp48 = ats2jspre_ref_get_elt(env0);
  ATSPMVlazyval_eval(tmp48); tmp49 = tmp48[1];
  // ATScaseofseq_beg
  tmplab_js = 1;
  while(true) {
    tmplab = tmplab_js; tmplab_js = 0;
    switch(tmplab) {
      ...
      if(ATSCKptriscons(tmp49)) { tmplab_js = 4; break; }
      case 2: // __atstmplab17
      tmpret47 = ats2jspre_ref_get_elt(env1);
      break;
      // ATSbranchseq_end
      // ATSbranchseq_beg
      ...
      tmp50 = tmp49[0];
      tmp51 = tmp49[1];
      ats2jspre_ref_set_elt(env0, tmp51);
      ats2jspre_ref_set_elt(env1, tmp50);
      tmpret47 = tmp50;
      break;
      // ATSbranchseq_end
    } // end-of-switch
...
//
  ...
  tmp55 = ats2jspre_stream_nth_opt(arg0, arg1);
  // ATScaseofseq_beg
  tmplab_js = 1;
  while(true) {
    tmplab = tmplab_js; tmplab_js = 0;
    switch(tmplab) {
      ...
      if(ATSCKptrisnull(tmp55)) { tmplab_js = 4; break; }
      ...
      tmpret54 = ats2jspre_StreamSubscriptExn_throw();
      break;
      // ATSbranchseq_end
    } // end-of-switch
    if (tmplab_js === 0) break;
