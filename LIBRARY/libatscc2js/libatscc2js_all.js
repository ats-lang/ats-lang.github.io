...
** The starting compilation time is: 2016-10-7: 11h:56m
**
*/
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      tmp196 = ats2jspre_stream_append(tmp197, tmp198);
...
//
  ...
  tmp200 = ats2jspre_stream_nth_opt(arg0, arg1);
  // ATScaseofseq_beg
  tmplab_js = 1;
  while(true) {
    tmplab = tmplab_js; tmplab_js = 0;
    switch(tmplab) {
      ...
      if(ATSCKptrisnull(tmp200)) { tmplab_js = 4; break; }
      case 2: // __atstmplab89
      tmp201 = tmp200[0];
      // ATSINSfreecon(tmp200);
      tmpret199 = tmp201;
      break;
      // ATSbranchseq_end
      // ATSbranchseq_beg
      ...
      tmpret199 = ats2jspre_StreamSubscriptExn_throw();
      break;
      // ATSbranchseq_end
    } // end-of-switch
    if (tmplab_js === 0) break;
